(function() {
    ...
    */
    ...
    function oa(a) {
        a = ba(a.g);
        ca(a, function(b, c) { return b.g - c.g });
        return a
    };
    ...
    n.prototype.has = function(a) { return null != this.g[a.g] };
    n.prototype.get = function(a, b) { return p(this, a.g, b) };
    n.prototype.set = function(a, b) { q(this, a.g, b) };
    n.prototype.add = function(a, b) { r(this, a.g, b) };

    function t(a, b) {
        for (var c = oa(a.j()), d = 0; d < c.length; d++) {
            var e = c[d],
                g = e.g;
            if (null != b.g[g]) { a.i && delete a.i[e.g]; var f = 11 == e.i || 10 == e.i; if (e.m) { e = u(b, g); for (var h = 0; h < e.length; h++) r(a, g, f ? e[h].clone() : e[h]) } else e = v(b, g), f ? (f = v(a, g)) ? t(f, e) : q(a, g, e.clone()) : q(a, g, e) }
        }
    }
    ...
    function p(a, b, c) { var d = v(a, b); return a.l[b].m ? d[c || 0] : d }
    ...
    function u(a, b) { return v(a, b) || [] }

    function x(a, b) { return a.l[b].m ? null != a.g[b] ? a.g[b].length : 0 : null != a.g[b] ? 1 : 0 }
    ...
    function A() {}
    A.prototype.g = function(a) { new a.i; throw Error("Unimplemented"); };
    A.prototype.i = function(a, b) {
        ...
        if (!a.u) return b;
        a = a.v;
        if (a === String) { if ("number" === typeof b) return String(b) } else if (a === Number && "string" === typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || B.test(b))) return Number(b);
        return b
    };
    var B = /^-?[0-9]+$/;
    ...
    D.prototype.g = function(a, b) { return D.$.g.call(this, a, b) };

    function E(a, b) { null != a && this.g.apply(this, arguments) }
    E.prototype.i = "";
    E.prototype.set = function(a) { this.i = "" + a };
    ...
    E.prototype.toString = function() { return this.i };
    /*
    ...
    */
    function F() { n.call(this) }
    m(F, n);
    var pa = null;

    function G() { n.call(this) }
    m(G, n);
    var qa = null;
    ...
    var J = {
        ...
        va = {
            ...
            MN: [, [, , "[12]\\d{7,9}|[57-9]\\d{7}", , , , , , , [8, 9, 10],
                ...
                [, , , , , , , , , [-1]],
                [, , , , , , , , , [-1]],
                [, , "712[0-79]\\d{4}|7(?:1[013-9]|[25-8]\\d)\\d{5}", , , , "75123456", , , [8]], "MN", 976, "001",
                "0", , , "0", , , , [
    ...
    */
    ...
    function Ha(a) { return 2 > a.length ? !1 : O(Fa, a) }
    ...
    function Ka(a) { return null != a && (1 != x(a, 9) || -1 != u(a, 9)[0]) }

    function P(a, b) { for (var c = new E, d, e = a.length, g = 0; g < e; ++g) d = a.charAt(g), d = b[d.toUpperCase()], null != d && c.g(d); return c.toString() }

    function Q(a) { return null != a && isNaN(a) && a.toUpperCase() in va }

    function La(a, b, c) {
        if (0 == p(b, 2) && null != b.g[5]) { var d = w(b, 5); if (0 < d.length) return d }
        d = w(b, 1);
        var e = R(b);
        ...
        a: {
            ...
            for (var g, f = a.length, h = 0; h < f; ++h) {
                ...
                if (0 == l || 0 == e.search(p(g, 3, l - 1)))
                    if (l = new RegExp(p(g, 1)), O(l, e)) { a = g; break a }
            }
            a = null
        }
    ...
    function R(a) { if (null == a.g[2]) return ""; var b = "" + p(a, 2); return null != a.g[4] && p(a, 4) && 0 < w(a, 8) ? Array(w(a, 8) + 1).join("0") + b : b }
    ...
    function W(a, b) { return X(a, p(b, 1)) ? X(a, p(b, 5)) ? 4 : X(a, p(b, 4)) ? 3 : X(a, p(b, 6)) ? 5 : X(a, p(b, 8)) ? 6 : X(a, p(b, 7)) ? 7 : X(a, p(b, 21)) ? 8 : X(a, p(b, 25)) ? 9 : X(a, p(b, 28)) ? 10 : X(a, p(b, 2)) ? p(b, 18) || X(a, p(b, 3)) ? 2 : 0 : !p(b, 18) && X(a, p(b, 3)) ? 1 : -1 : -1 }
    ...
    function X(a, b) { var c = a.length; return 0 < x(b, 9) && -1 == u(b, 9).indexOf(c) ? !1 : O(w(b, 2), a) }
    ...
    function Na(a, b) {
        ...
        if (null == c) a = null;
            ...
            b = R(b);
            for (var d, e = c.length, g = 0; g < e; g++) { d = c[g]; var f = U(a, d); if (null != f.g[23]) { if (0 == b.search(p(f, 23))) { a = d; break a } } else if (-1 != W(b, f)) { a = d; break a } }
            a = null
        }
        return a
    }

    function T(a) { a = J[a]; return null == a ? "ZZ" : a[0] }
    ...
    function Ra(a, b, c, d) {
        ...
        h = 0;
        l = e.toString();
        try { h = Pa(a, l, f, b, d, g) } catch (M) { if ("Invalid country calling code" == M.message && L.test(l)) { if (l = l.replace(L, ""), h = Pa(a, l, f, b, d, g), 0 == h) throw M; } else throw M; }
    ...
    k("intlTelInputUtils.getExampleNumber", function(a, b, c) {
        try {
            var d = K.g();
            a: {
                if (Q(a)) { var e = V(U(d, a), c); try { if (null != e.g[6]) { var g = p(e, 6); var f = Ra(d, g, a, !1); break a } } catch (h) {} }
                f = null
            }
            return La(d, f, b ? 2 : 1)
        } catch (h) { return "" }
    });
    k("intlTelInputUtils.getExtension", function(a, b) { try { return p(Z(K.g(), a, b), 3) } catch (c) { return "" } });
